...
# abasu - 27.09.2016 - updated values from d03a97ebe1fcf3b9f10cf4eb066a1b97ddd4e09a
#                                     to   3981d22da3cbb035d52fbe44949c394412ba7bb5
...
describe RootController do
  ...
  it "should return the API index" do
    ...
    json.should == {
      "type"=>"grid", 
      "uid"=>"grid5000", 
      "version"=>"3981d22da3cbb035d52fbe44949c394412ba7bb5", 
      ...
      "links"=>[
        ...
        {"rel"=>"version", "type"=>"application/vnd.grid5000.item+json", "href"=>"/versions/3981d22da3cbb035d52fbe44949c394412ba7bb5"}, 
  ...
  it "should correcly add the api-prefix if any" do
    ...
    json.should == {
      ...
      "links"=>[
        ...
        {"rel"=>"version", "type"=>"application/vnd.grid5000.item+json", "href"=>"/sid/versions/3981d22da3cbb035d52fbe44949c394412ba7bb5"}, 
